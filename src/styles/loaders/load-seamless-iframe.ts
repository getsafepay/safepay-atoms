...
function loadSeamlessIframeStyles() {
  try {
    ...
    console.error(
      o,
      "Unable to add SeamlessIframe styles to the window using the corresponding js file"
    );
  }
}
...
function loadSeamlessIframeJsChunks() {
  try {
    ...
    console.error(
      o,
      "Unable to add SeamlessIframe style imports to the window using the corresponding js file"
    );
  }
}
